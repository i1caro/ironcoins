...
# from pieces.models import Stats
...
class TestFigure(MainTestClass, FigureInit):
    ...
    def test_path(self):
        result = self.create_figure().path_to(destination)
        path = '((1,2),(2,3),(3,4),(4,5),(5,5),(6,5),(7,5),(8,5),(9,5),(10,5))'
        self.assertEqual(path, result)


class TestFigureCircularMovement(MainTestClass, FigureInit):
    source = Hex(2,2)
    left = Hex(1,2)
    top_left = Hex(1,3)
    top = Hex(2,3)
